...
ent-SilverSwordWega = серебряный меч (Delta-V)
    .desc = Прекрасный меч, сделанный почти полностью из серебра. Лезвие туповато и плохо держит заточку, но всё равно остаётся крепким клинком.
