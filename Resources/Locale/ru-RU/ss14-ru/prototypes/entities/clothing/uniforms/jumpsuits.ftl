...
ent-ClothingUniformBlackTurtleneckWega = чёрная водолазка (Delta-V)
    .desc = Простая чёрная водолазка. Идеально подходит для любого начинающего шпиона.
ent-ClothingUniformJumpsuitSecTurtleWega = водолазка старшего офицера (Delta-V)
    .desc = Удобная облегающая водолазка для тех, кто обладает решимостью дослужиться до старшего офицера.
ent-ClothingUniformJumpsuitSecWhiteWega = белый комбинезон службы безопасности (Delta-V)
    .desc = Стильная белая рубашка и тёмные брюки для спокойного и собранного офицера безопасности.

ent-ClothingUniformJumpsuitMailCarrierWega = комбинезон почтальона (Nyanotrasen)
    .desc = Враг собак повсюду.
ent-ClothingUniformJumpsuitTshirtJeansWega = белая футболка и джинсы (Nyanotrasen)
    .desc = Даже в космосе этот образ всё ещё в моде.
ent-ClothingUniformJumpsuitTshirtJeansGrayWega = серая футболка и джинсы (Nyanotrasen)
    .desc = Хотя в космосе нет лесов, этот образ всё ещё практичен.
ent-ClothingUniformJumpsuitTshirtJeansPeachWega = персиковая футболка и джинсы (Nyanotrasen)
    .desc = Хотя любимый магазин эмо-одежды остался дома, этот образ всё ещё дерзок.
ent-ClothingUniformJumpsuitPrisonGuardWega = форма тюремщика (Nyanotrasen)
    .desc = Удобный, прочный, водонепроницаемый костюм, созданный для комфорта и безопасности тюремного персонала.
