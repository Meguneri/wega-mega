...
Руководство по работе с этим репозиторием (форк ss14-wega / Space Station 14). `CLAUDE.md` — зеркало этого файла для Claude Code: осмысленные правки вноси в оба файла.
