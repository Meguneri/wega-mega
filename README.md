...
(`PlayerAttachedEvent`) **и** на сервере присутствует `RaidControllerComponent` (маркер активного
рейд-режима). Это работает только в режиме рейда и не затрагивает арену-мод.
